...
<html lang="es">
  <head>
    <meta charset="utf-8">
    <meta name="description" content="Tienda Virtual MEGA BIT">
    <title><?= $data['page_tag']?></title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="author" content="Maycol Mendoza">
    <meta name="theme color" content="#00a8eb">
  ...
  <body class="app sidebar-mini">
    ...
    <style>
      @font-face{
        ...
        src: url(<?= media();?>/fonts/breakaway.ttf);
      }
      #mega{
        font-family: Breakaway;
        font-size: 50px;
    ...
    <header class="app-header"><a id= "mega" class="app-header__logo" href="<?= base_url();?>/dashboard">MEGA BIT</a>
